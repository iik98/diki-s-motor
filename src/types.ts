...
export interface ServiceOrder { id: string; customerId: string; unitId: string; mechanicId: string; laborCost: number; totalCost: number; status?: string; createdAt?: any ,note?:string}
